// Client-side upload guard (pilot-ready pass). The API still validates and
// malware-scans every upload server-side — this only gives a paralegal an
// immediate, friendly rejection instead of waiting for a POST to fail, and
// narrows the OS file picker via the `accept` attribute.
//
